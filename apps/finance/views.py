...
from .models import Receipt, Invoice, InvoiceItem
...
class InvoiceUpdateView(LoginRequiredMixin, UpdateView):
    model = Invoice
    fields = ["student", "session", "term", "class_for", "balance_from_previuos_session"]
...
class ReceiptCreateView(LoginRequiredMixin, CreateView):
    ...
    suceess_url = reverse_lazy("invoice-list")
